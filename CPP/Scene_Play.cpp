...
Scene_Play::Scene_Play() {
	...
	*/
	...
	txt_score.setString("Score : " + to_string(m_score) + " \nTime: "+ to_string(seconds_game)); //txt_score.setString("Score : " + to_string(m_score) + ""); //txt_score.setString("Score : " + score + "");
...
void Scene_Play::Update (Game & playgame) {
	...
	aceleration=acelerador.getElapsedTime().asSeconds();
